...
// To listen for any page that wants the user's name
window.addEventListener('load', function() {
  const userName = localStorage.getItem('userName');
  if (userName) {
    // Use the userName in your HTML or JavaScript
...
// Function to check that the user has an input before moving on to the next page
...
// Function that shows more information about the deties on the result page
